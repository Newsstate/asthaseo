...
def get_pagespeed_data(target_url: str, fast: Optional[bool] = None) -> Dict[str, Any]:
    ...
    # --- JSON-LD quick scan (leave microdata/RDFa empty if unsupported) ---
    json_ld = []
    ...
    result.update({
        ...
        "json_ld": json_ld,
        "microdata": [],   # populate if you later implement it
        "rdfa": [],        # populate if you later implement it
